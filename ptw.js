...
function update_country_data(country, rating, result) {
    ...
    countries[country].games_played++;
    if (countries[country].highest_rating_played < rating) {
        countries[country].highest_rating_played = rating;
    }
    if (countries[country].lowest_rating_played > rating ||
        countries[country].lowest_rating_played == 0) {
        countries[country].lowest_rating_played = rating;
    }
}
