...
function map_popup(geo, data) {
    return ['<div class="hoverinfo"><strong>',
            geo.properties.name,
            '<br>Games played: ' + data.numberOfThings,
            '<br>Highest rated player played: ' +  data.highest_rating_played,
            '<br>Lowest rated player played: ' +  data.lowest_rating_played,
            '</strong></div>'].join('');
}
...
var map = new Datamap({
    ...
    responsive: true,
    geographyConfig: { popupTemplate: map_popup }
});
